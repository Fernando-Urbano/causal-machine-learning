...
# Multivariate Regression
marketing_data_with_interaction_demeaned <- marketing_data %>%
  mutate(interaction_spend_city = (spend - mean(spend)) * city)

ols_visitors_with_interaction <- lm(
  visitors ~ ., data = marketing_data_with_interaction_demeaned
)
summary(ols_visitors_with_interaction)
...
# (Intercept)             12.2342     0.2199  55.643  < 2e-16 ***
#   spend                    2.6232     0.4879   5.377 2.14e-07 ***
#   city                    -4.9755     0.1856 -26.812  < 2e-16 ***
#   interaction_spend_city   0.9683     0.7139   1.356    0.177    
# ---
#   Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
# 
